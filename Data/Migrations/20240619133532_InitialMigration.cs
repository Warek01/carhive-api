    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("29aa0b25-d42a-4877-8b4c-3c359e5bee77"),
                columns: new[] { "password", "roles" },
                values: new object[] { "$2a$13$7qny3C85BdvPoeFRrjxNw.R6JCqAY7WiOOic9.tJwzW4rL7QToOXK", new List<UserRole> { UserRole.ListingCreator } });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("7e4d9d9b-97d8-4e5c-ad49-abe09837c70c"),
                columns: new[] { "password", "roles" },
                values: new object[] { "$2a$13$ihzU3sNVF4tWkzueudBQLuBVaiRg5o/t64G.BG8AE4fmSWC7toq5i", new List<UserRole> { UserRole.ListingCreator } });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("e00e715a-fe5e-4814-b595-6cc3cd316fca"),
                columns: new[] { "password", "roles" },
                values: new object[] { "$2a$13$2djJc.fXR.wKjQpZXc3Xj.MxDizXPWUlmRD71HC4KAW1MKOTR9IUe", new List<UserRole> { UserRole.Admin } });
        }
    }
}
